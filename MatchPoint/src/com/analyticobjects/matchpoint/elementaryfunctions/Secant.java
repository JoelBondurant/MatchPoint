 ...
 */
public class Secant implements ElementaryFunction
{
    private static final String name = "Secant";
    private static final String[] vars = {"x"};
    private static final FunctionString fstr = new FunctionString("sec(x)",vars,null);
    public static final String fstrHeader = "sec(";
    public static final String fstrTrailer = ")";
    private static final FunctionString dfstr = new FunctionString("sec(x)*tan(x)",vars,null);
