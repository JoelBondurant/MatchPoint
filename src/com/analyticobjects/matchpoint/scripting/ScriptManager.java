...
public class ScriptManager
{
    ...
    private static final String hpFactoryFunction = "function HighPrecisionNumber(a){return com.analyticobjects.matchpoint.scripting.HighPrecisionNumber.createNew(a);}";
